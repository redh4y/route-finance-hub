...
const operationBadgeVariant = (operation: AuditRow["operation"]) => {
  if (operation === "INSERT") return "default";
    ...
    <MainLayout>
      <PageTransition>
        <div className="page-header">
          ...
          <p className="page-subtitle">Rastreabilidade de alteracoes no banco (insert, update, delete)</p>
        </div>
        ...
        <Card className="mb-4">
          <CardContent className="pt-4 pb-4">
            <div className="grid gap-3 md:grid-cols-[1fr_220px_220px]">
              <Input
                placeholder="Buscar por tabela, registro, usuario ou campo alterado..."
                value={search}
              ...
              <Select value={operationFilter} onValueChange={setOperationFilter}>
                ...
                <SelectContent>
                  <SelectItem value="all">Todas operacoes</SelectItem>
