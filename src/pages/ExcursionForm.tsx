  ...
  return (
    <MainLayout>
      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle>Dados da Excursão</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-2 space-y-2">
                <Label>Destino *</Label>
                <Input value={destination} onChange={(e) => setDestination(e.target.value)} placeholder="Cidade" />
              </div>
              <div className="space-y-2">
                <Label>UF</Label>
            ...
            <div className="space-y-2">
              ...
              <Input value={boardingLocation} onChange={(e) => setBoardingLocation(e.target.value)} />
            </div>
